...
One lap is one lap. Yesterday's survey found 1.68% of real magnets below 140
counts; today's lowest was 146 and none fell under. Both are true. The lesson
is not that 140 would have been safe today — it is that the floor moves with
air gap, battery and magnet, which is why the ruling puts no floor above the
entry threshold rather than trying to place one cleverly.
