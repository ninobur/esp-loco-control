...
```sh
c++ -std=c++17 -Wall -Wextra -Werror -fsanitize=address,undefined -fno-omit-frame-pointer -I firmware/NAVI_COHERENCE/IR_ARCHITECTURE_0_4 firmware/NAVI_COHERENCE/IR_ARCHITECTURE_0_4/tests/test_ir_architecture.cpp -o /private/tmp/test_ir_architecture
/private/tmp/test_ir_architecture
arduino-cli compile --fqbn esp32:esp32:esp32 --warnings all firmware/NAVI_COHERENCE/IR_ARCHITECTURE_0_4/tests/esp32_compile_check
```
