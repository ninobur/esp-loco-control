/*
 * NAVI_COHERENCE 0.2 - Toby, initial Manual field-test candidate.
...
#define SKETCH_NAME    "NAVI_COHERENCE_0_2"
#define BUILD_CLASS    "INITIAL_MANUAL_FIELD_TEST"
#define BUILD_SUBTITLE "Point landmarks + per-interval IR gate + rolling mapped DNA"
...
void setup(){
  ...
  Serial.println("[BOOT] NAVI_COHERENCE: declare interval/direction; NAVI expects the next mapped magnet. AUTO gated.");
}
