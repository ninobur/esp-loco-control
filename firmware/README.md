...
|---|---|---|---|---|
| `NAVI_COHERENCE/IR_ARCHITECTURE_0_4/` | Independent measurement foundation; not locomotive firmware | Health/readiness, irreversible IR Epochs, timestamped odometry points and NAVI-owned MM reference; successor to Sam's architecture 0.3 ZIP | **Host ASan/UBSan tests and ESP32 compile-only fixture pass, 2026-09-23. Not integrated or flashed.** Healthy zero/dwell, outage/recovery, reset/source identity and delayed-Hall reference tested. Existing TX stationary contrast limitation reproduced and left explicit | `docs/NAVI_IR_HEALTH_STEP1_20260923.md`; package README; current operator handoff and cyclometer criterion |
