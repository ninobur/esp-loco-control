...
| `QUORUM/QUORUM.ino` — 1.10 | Production control | Adds console-authority firmware items P11/P13/P14 while retaining 1.8 and 1.9 behavior | **Built and implementation-reported; review/field status pending** | `docs/QUORUM_1_10_IMPLEMENTATION_REPORT.md`; commit `c39c439` |
