...
| `test-programs/IR_SPEED_LOCAL/IR_SPEED_LOCAL.ino` | Diagnostic / prototype | Lean local QRE1113 speed contract; 10-spoke, measured 96.52 mm rolling circumference; 1 Hz latest-speed telemetry and 5 s factual health beat, no per-pulse MQTT | **Built; awaiting CODEX/Claude QC and daylight field gate; not production and not integrated into QUORUM** | decisions 0020/0021; `test-programs/IR_SPEED_LOCAL/README.md`; synchronized 2026-08-09/10 evidence |
