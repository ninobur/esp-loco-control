...
| `test-programs/NAVI_COHERENCE_0_5_AUTO_ENABLED/NAVI_COHERENCE_0_5_AUTO_ENABLED.ino` | Control experiment, **AUTO enabled** | Toby only; 0.4 navigator plus operator rulings of 2026-09-22: AUTO enabled, IR window ±15%, a unique 10/10 observed polarity sequence (with ≥2 disagreements at the current position) overrules a bad declaration; direction before declaration no longer reports TRACKING at MM0 | **Built 2026-09-22; NOT flashed. Host suite ASan/UBSan clean (2,052 offset corrections, 6,840 single-misread holds); ESP32 build clean, 0 sketch warnings, 1,002,259 B (76%)** | `docs/decisions/0090-sequence-overrules-declaration-15pct-window-auto-enabled.md`; `docs/NAVI_COHERENCE_0_4_FIRST_LAP_20260922.md`; `docs/NAVI_COHERENCE_0_4_SECOND_RUN_20260922.md`; sketch README |
