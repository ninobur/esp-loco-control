#!/usr/bin/env bash
# X19 host tests. Two files, deliberately: the synthetic gates assert the
...
/tmp/x19_gate
echo
echo "=== replay_x19_20260915 ==="
$CXX -O2 -std=c++17 -Wall -o /tmp/x19_replay replay_x19_20260915.cpp
/tmp/x19_replay fixtures_otto_20260915.txt | tail -14
