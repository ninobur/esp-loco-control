...
```sh
c++ -std=c++17 -Wall -Wextra -Werror -fsanitize=address,undefined -fno-omit-frame-pointer -I firmware/test-programs/NAVI_COHERENCE_0_6_IR_HEALTH firmware/test-programs/NAVI_COHERENCE_0_6_IR_HEALTH/tests/test_ir_health_monitor.cpp -o /tmp/test_ir_health_monitor
python3 firmware/test-programs/NAVI_COHERENCE_0_6_IR_HEALTH/tests/test_health_json.py /tmp/test_ir_health_monitor
```
