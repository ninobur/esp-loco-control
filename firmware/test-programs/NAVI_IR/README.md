...
```sh
c++ -std=c++17 -Wall -Wextra -Werror -fsanitize=address,undefined -fno-omit-frame-pointer -I firmware/test-programs/NAVI_IR firmware/test-programs/NAVI_IR/tests/test_navi_ir.cpp -o /private/tmp/test_navi_ir
/private/tmp/test_navi_ir
c++ -std=c++17 -Wall -Wextra -Werror -fsanitize=address,undefined -fno-omit-frame-pointer -I firmware/test-programs/NAVI_IR firmware/test-programs/NAVI_IR/tests/replay_core.cpp -o /private/tmp/replay_navi_ir
python3 firmware/test-programs/NAVI_IR/tests/replay_noon.py /private/tmp/replay_navi_ir
